...
import static com.example.chetan.timeapp.Thursday.list3;
import static com.example.chetan.timeapp.Thursday.s3;
...
public class Thursday extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_empty_activity4);
        s3=" day='3'";
        list3= (ListView) findViewById(R.id.list4);

        Cursor c = getContentResolver().query(database.CONTENT_URI,null,s3,null,null) ;
        dadapter = new Dadapter(this,c) ;
        list3.setAdapter( dadapter);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(Thursday.this,save_data.class);
                //i.putExtra("id",0);
                Bundle b = new Bundle();
                b.putInt("DAY",3);
                b.putInt("id",0) ;
...
class Singlerow4
{
    ...
    public Singlerow4(String subject,String teacher,String type,String room,String timings ) {
...
class Dadapter extends BaseAdapter {
    ...
    private void showPopupMenu(View view,int position) {
        ...
        popup.setOnMenuItemClickListener(new MyMenuItemClickListener3(position,context,_id,data));
        popup.show();
    }
...
class MyMenuItemClickListener3 implements PopupMenu.OnMenuItemClickListener {
    ...
    public MyMenuItemClickListener3(int positon, Context context, int id,String []data) {
    ...
    public boolean onMenuItemClick(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.menu_edit:
                ...
                Bundle b = new Bundle() ;
                b.putInt("id",1) ;
                Cursor cc = c.getContentResolver().query(database.CONTENT_URI,null,s3,null,null) ;
            ...
            case R.id.menu_delete:
                ...
                //Cursor
                cc = c.getContentResolver().query(database.CONTENT_URI,null,s3,null,null) ;
                cc.moveToPosition(position) ;
...
//                notifyItemRangeChanged(position,mDataSet.size());
               // Toast.makeText(c, position+"Done for now", Toast.LENGTH_SHORT).show();
                cc = c.getContentResolver().query(database.CONTENT_URI,null,s3,null,null) ;
                Dadapter dadapter = new Dadapter(c,cc);
                list3.setAdapter( dadapter);
