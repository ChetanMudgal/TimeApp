...
import static com.example.chetan.timeapp.Tuesday.s1;
...
public class Tuesday extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Cursor c = getContentResolver().query(database.CONTENT_URI,null,s1,null,null) ;
        badapter = new Badapter(this,c) ;
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(Tuesday.this,save_data.class);
                //i.putExtra("id",0);
                Bundle b = new Bundle();
                b.putInt("DAY",1);
                b.putInt("id",0) ;
...
class Singlerow2
{
    ...
    public Singlerow2(String subject,String teacher,String type,String room,String timings ) {
...
class Badapter extends BaseAdapter {
    ArrayList<Singlerow2> list1;
    Context context;
    Cursor cursor ;
    String [] data=new String[6];
    int _id;
    ImageButton imageButton;
    Badapter(Context c,Cursor cc){
        context=c;
        cursor=cc;
    }
    ...
    private void showPopupMenu(View view,int position) {
        ...
        popup.setOnMenuItemClickListener(new MyMenuItemClickListener1(position,context,_id,data));
        popup.show();
    }
...
class MyMenuItemClickListener1 implements PopupMenu.OnMenuItemClickListener {
    ...
    public MyMenuItemClickListener1(int positon, Context context, int id,String []data) {
    ...
    public boolean onMenuItemClick(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.menu_edit:
                ...
                Bundle b = new Bundle() ;
                b.putInt("id",1) ;
                Cursor cc = c.getContentResolver().query(database.CONTENT_URI,null,s1,null,null) ;
            ...
            case R.id.menu_delete:
                ...
                //Cursor
                cc = c.getContentResolver().query(database.CONTENT_URI,null,s1,null,null) ;
                cc.moveToPosition(position) ;
                deleteCard(cc.getInt(cc.getColumnIndex(database._ID)),c);

                cc = c.getContentResolver().query(database.CONTENT_URI,null,s1,null,null) ;
                Badapter badapter = new Badapter(c,cc);
                Tuesday.list1.setAdapter( badapter);
